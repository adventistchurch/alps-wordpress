...
function crb_attach_theme_options()
{
    ...
    if (function_exists( 'icl_get_languages' )) {
        ...
        foreach ($languages as $langCode => $lang) {
            $globalFields[] = Field
                ::make('image', 'logo_' . $langCode, __('Logo ' . $lang['native_name'] . ' (' . $lang['language_code'] . ')'))
                ->set_width(33);
        }
    } else {
        $globalFields[] = Field::make('image', 'logo', __('Logo'));
    }

    $globalFields = array_merge($globalFields, [
        Field
    ...
    Container
        ...
        ->add_tab(__('GLOBAL'), $globalFields)
