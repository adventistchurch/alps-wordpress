    ...
    ->add_tab( __( 'GLOBAL' ), array(
      ...
      Field::make( 'select', 'theme_color', __( 'Theme Color' ) )
        ...
        Field::make( 'textarea', 'site_branding_statement', __( 'Site Branding Statement' ))
          ...
          ->set_rows( 2 )
          ->set_width( 50 ),
        Field::make( 'textarea', 'global_branding_statement', __( 'Global Branding Statement' ))
       ...
       ->add_tab( __( 'POSTS OPTIONS' ), array(
        ...
        Field::make( 'checkbox', 'index_hide_sidebar', __( 'Hide The Sidebar' ) )
          ->set_option_value( 'true' )
        ...
        Field::make( 'checkbox', 'posts_label', __( 'Category Posts Feed Label' ) )
          ->set_option_value( 'true' )
          ->set_help_text( 'Select to display the label "Category" on category posts feed.' )
          ->set_width( 33 ),
        Field::make( 'checkbox', 'posts_grid', __( 'Posts Feed Grid' ) )
          ->set_option_value( 'true' )
      ...
      ->add_tab( __( 'SABBATH COLUMN' ), array(
        ...
        Field::make( 'image', 'sabbath_icon', __( 'Sabbath Icon' ) )
          ->set_width( 50 ),
        Field::make( 'image', 'sabbath_background', __( 'Sabbath Background Image' ) )
          ->set_width( 50 ),
        Field::make( 'checkbox', 'sabbath_scroll', __( 'Hide Sabbath Icon Until Scroll' ) )
            ->set_option_value( 'true' )
            ->set_help_text( 'Select to hide the sabbath icon till you scroll.' )
            ->set_width( 33 ),
        Field::make( 'checkbox', 'sabbath_hide', __( 'Hide the sabbath column' ) )
            ->set_option_value( 'true' )
      ...
      ->add_tab( __( 'FOOTER CONTENT' ), array(
          ...
          Field::make( 'complex', 'footer_address', __( 'Footer Address' ) )
            ...
            ->set_min( 1 )
            ->set_max( 1 ),
        Field::make( 'image', 'footer_logo_icon', __( 'Footer Logo Icon' ) )
