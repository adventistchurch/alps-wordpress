...
function crb_attach_hero() {
  Container::make( 'post_meta', 'ALPS: Hero' )
    ...
    ->add_fields( array(
        ...
        Field::make( 'image', 'hero_image', __( 'Hero Image' ) )
           ->set_conditional_logic( array(
                'relation' => 'OR', // Optional, defaults to "AND"
                    array( 'field' => 'hero_type', 'value' => 'default' ),
                    array( 'field' => 'hero_type', 'value' => 'full' ),
            ) ),
        Field::make( 'textarea', 'hero_title', __( 'Hero Title' ) )
        ...
        Field::make( 'text', 'hero_kicker', __( 'Hero Kicker' ) )
        ...
        Field::make( 'text', 'hero_link_url', __( 'Hero Link URL' ) )
        ...
        Field::make( 'checkbox', 'hero_image_extended', __( 'Hero Image Extended' ) )
        ...
        Field::make( 'checkbox', 'hero_scroll_hint', __( 'Hero Scroll Hint' ) )
            ->set_option_value( 'true' )
            ->set_help_text( 'Check to extend the hero image over the sabbath column.' )
            ->set_width( 50 )
             ->set_conditional_logic( array(
        ...
        Field::make( 'complex', 'hero_column', __( 'Hero Column (3 Columns)' ) )
            ->set_conditional_logic( array(
                array( 'field' => 'hero_type', 'value' => 'column' ),
            ) )
            ->add_fields( array(
                Field::make( 'image', 'hero_image_column', __( 'Hero Image' ) ),
                Field::make( 'textarea', 'hero_title_column', __( 'Hero Title' ) )
                    ->set_help_text( __( 'The title of the hero image.') )
                    ->set_rows( 2 )
                    ->set_width( 50 ),
                Field::make( 'text', 'hero_kicker_column', __( 'Hero Kicker' ) )
                    ->set_help_text( __( 'Displays below the title in the hero image.' ) )
                    ->set_width( 50 ),
                Field::make( 'text', 'hero_link_url', __( 'Hero Link URL' ) )
                    ->set_help_text( __( 'Enter an URL to link the hero image.' ) )
...
function crb_post_in_banner() {
  Container::make( 'post_meta', 'ALPS: Hero Featured Post' )
    ->where( 'post_type', '=', 'page' )
    ->where( 'post_template', '=', 'views/template-posts.blade.php' )
    ->add_fields( array(
        Field::make( 'separator', 'crb_fpost_banner', __( 'Hero: Show Featured Post' ) ),
        Field::make( 'checkbox', 'show_hero_featured_post', __( 'Select to display a featured post in the hero.' ) )
            ->set_option_value( 'true' ),
        Field::make( 'association', 'hero_featured_post', __( 'Select - Hero Featured Post' ) )
            ->set_conditional_logic( array( array('field' => 'show_hero_featured_post', 'value' => true, ) ) )
            ->set_types( array( array( 'type' => 'post', 'post_type' => 'post' ) ) )
            ->set_max( 1 )
    ) );
}
...
function crb_post_feed_list() {
  Container::make( 'post_meta', 'ALPS: Post Feed List' )
    ->where( 'post_type', '=', 'page' )
    ->where( 'post_template', '=', 'views/template-posts.blade.php' )
    ->add_fields( array(
        Field::make( 'separator', 'crb_feed_list_banner', __( 'Post Feed - List' ) ),
        Field::make( 'radio', 'post_feed_list', __( 'Post Feed: List' ) )
            ->set_help_text( 'Displays as a list of posts.' )
            ->add_options( array(
        ...
        Field::make( 'separator', 'crb_feed_list_cat_sep', __( 'Select Post Category' ) )
             ->set_conditional_logic( array( array('field' => 'post_feed_list', 'value' => 'post_feed_list_category', ) ) ),
        Field::make( 'separator', 'crb_feed_list_pick_sep', __( 'Select Specific Posts' ) )
             ->set_conditional_logic( array( array('field' => 'post_feed_list', 'value' => 'post_feed_list_custom', ) ) ),
        // NEXT THREE FIELDS ARE SHOWN FOR BOTH
        Field::make( 'text', 'post_feed_list_title', __( 'Section Title' ) )
            ->set_help_text( __( 'Enter the title for this featured posts section.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_list', 'value' => 'post_feed_list_false', 'compare' => 'EXCLUDES' )
            ) ),
        Field::make( 'text', 'post_feed_list_link', __( 'Section Link' ) )
            ->set_help_text( __( 'Enter the link to the posts archive page.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_list', 'value' => 'post_feed_list_false', 'compare' => 'EXCLUDES' )
            ) ),
        Field::make( 'checkbox', 'post_feed_list_round_image', __( 'Round Image Thumbnail' ) )
            ->set_help_text( __( 'Check to make the image thumbnail round.' ) )
            ->set_option_value( 'true' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_list', 'value' => 'post_feed_list_false', 'compare' => 'EXCLUDES' )
        ...
        Field::make( 'association', 'post_feed_list_category_array', __( 'Select - Category' ) )
            ->set_help_text( __( 'Click on the category you want to select on the left and it will be selected on the right side. You can only select one category.' ) )
            ->set_types( array( array( 'type' => 'term', 'taxonomy' => 'category', ) ) )
            ->set_max( 1 )
            ->set_conditional_logic( array(
                array( 'field' => 'post_feed_list', 'value' => 'post_feed_list_category' )
            ) ),
        Field::make( 'text', 'post_feed_list_count', __( 'Number of Posts' ) )
            ->set_help_text( __( 'Enter the number of posts you would like to display. (If empty, defaults to 3 posts in the selected category)' ) )
            ->set_width( 50 )
           ->set_conditional_logic( array(
                array( 'field' => 'post_feed_list', 'value' => 'post_feed_list_category' )
            ) ),
        Field::make( 'text', 'post_feed_list_offset', __( 'Post Offset' ) )
        ...
        // ONLY SPECIFIC / SELECTED POSTS
         Field::make( 'association', 'post_feed_list_custom_array', __( 'Select - Custom Posts' ) )
             ->set_help_text( __( 'Click on the posts you want to select on the left and they will be selected on the right side.' ) )
            ->set_types( array( array( 'type' => 'post', 'post_type' => 'post' ) ) )
            ->set_conditional_logic( array( array('field' => 'post_feed_list', 'value' => 'post_feed_list_custom', ) ) )
    ) );
}
...
function crb_post_feed_full() {
  Container::make( 'post_meta', 'ALPS: Post Feed - Full Width' )
    ->where( 'post_type', '=', 'page' )
    ->where( 'post_template', '=', 'views/template-posts.blade.php' )
    ->add_fields( array(
        Field::make( 'separator', 'crb_feed_list_banner', __( 'Post Feed - Full Width' ) ),
        Field::make( 'radio', 'post_feed_full', __( 'Post Feed: Full Width' ) )
            ->set_help_text( 'Displays as a list of posts.' )
            ->add_options( array(
                'post_feed_full_false'      => 'None',
                'post_feed_full_category'    => 'Select a category of posts to feature.',
            ) ),
        Field::make( 'separator', 'crb_feed_full_cat_sep', __( 'Select Post Category' ) )
             ->set_conditional_logic( array( array('field' => 'post_feed_full', 'value' => 'post_feed_full_category', ) ) ),

        // NEXT THREE FIELDS ARE SHOWN FOR BOTH
        Field::make( 'text', 'post_feed_full_title', __( 'Section Title' ) )
            ->set_help_text( __( 'Enter the title for this featured posts section.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_full', 'value' => 'post_feed_full_category' )
            ) ),
        Field::make( 'text', 'post_feed_full_link', __( 'Section Link' ) )
            ->set_help_text( __( 'Enter the link to the posts archive page.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
        ...
        Field::make( 'checkbox', 'post_feed_full_featured', __( 'Full Width Featured Post' ) )
            ->set_help_text( __( 'Select to include a post full width.' ) )
            ->set_option_value( 'post_feed_full_featured_true' )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_full', 'value' => 'post_feed_full_category' )
            ) ),
         Field::make( 'association', 'post_feed_full_featured_array', __( 'Featured Post' ) )
            ->set_help_text( __( 'Select (1) post to feature as a full width post.' ) )
            ->set_types( array( array( 'type' => 'post', 'post_type' => 'post' ) ) )
            ->set_max( 1 )
            ->set_conditional_logic( array(
                array( 'field' => 'post_feed_full', 'value' => 'post_feed_full_category' ),
                array( 'field' => 'post_feed_full_featured', 'value' => true ),
            ) ),
        Field::make( 'text', 'post_feed_full_offset', __( 'Post Offset' ) )
            ->set_help_text( __( 'Enter the number of posts you would like to offset.' ) )
            ->set_width( 50 )
           ->set_conditional_logic( array(
                array( 'field' => 'post_feed_full', 'value' => 'post_feed_list_category' )
            ) ),
        Field::make( 'association', 'post_feed_full_category_array', __( 'Select - Category' ) )
            ->set_help_text( __( 'Click on the category you want to select on the left and it will be selected on the right side. You can only select one category.' ) )
            ->set_types( array( array( 'type' => 'term', 'taxonomy' => 'category', ) ) )
            ->set_max( 1 )
            ->set_conditional_logic( array(
...
function crb_post_feed_archive() {
  Container::make( 'post_meta', 'ALPS: Post Feed Archive' )
    ->where( 'post_type', '=', 'page' )
    ->where( 'post_template', '=', 'views/template-posts.blade.php' )
    ->add_fields( array(
        Field::make( 'separator', 'crb_feed_archive_banner', __( 'Post Feed - Archive' ) ),
        Field::make( 'radio', 'post_feed_archive', __( 'Post Feed: Archive' ) )
            ->set_help_text( 'Displays as a list of posts.' )
            ->add_options( array(
                'post_feed_archive_false'          => 'None',
                'post_feed_archive_category'    => 'Select a category of posts to feature.',
            ) ),
        Field::make( 'separator', 'crb_feed_archive_cat_sep', __( 'Select Post Category' ) )
             ->set_conditional_logic( array( array('field' => 'post_feed_archive', 'value' => 'post_feed_archive', ) ) ),


        Field::make( 'text', 'post_feed_archive_title', __( 'Section Title' ) )
            ->set_help_text( __( 'Enter the title for this featured posts section.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
                array( 'field' => 'post_feed_archive', 'value' => 'post_feed_archive_category' )
            ) ),
        Field::make( 'text', 'post_feed_archive_link', __( 'Section Link' ) )
            ->set_help_text( __( 'Enter the link to the posts archive page.' ) )
            ->set_width( 50 )
            ->set_conditional_logic( array(
                'relation' => 'AND',
        ...
        Field::make( 'text', 'post_feed_archive_offset', __( 'Post Offset' ) )
            ->set_help_text( __( 'Enter the number of posts you would like to offset.' ) )
            ->set_width( 50 )
           ->set_conditional_logic( array(
                array( 'field' => 'post_feed_archive', 'value' => 'post_feed_archive_category' )
            ) ),
        Field::make( 'association', 'post_feed_archive_category_array', __( 'Select - Category' ) )
            ->set_help_text( __( 'Click on the category you want to select on the left and it will be selected on the right side. You can only select one category.' ) )
            ->set_types( array( array( 'type' => 'term', 'taxonomy' => 'category', ) ) )
            ->set_max( 1 )
            ->set_conditional_logic( array(
