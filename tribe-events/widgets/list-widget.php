...
if ( $posts ) : ?>
		...
		foreach ( $posts as $post ) :
			...
			<div class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				...
				<h4 class="tribe-event-title">
					<a class="font--secondary--m theme--primary-text-color" href="<?php echo esc_url( tribe_get_event_link() ); ?>" rel="bookmark"><?php the_title(); ?></a>
				</h4>
				...
				<div class="tribe-event-duration font--secondary--xs">
	...
	<p class="tribe-events-widget-link">
		<a class="btn" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'the-events-calendar' ), $events_label_plural ); ?></a>
	</p>
