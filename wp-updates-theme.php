...
new WPUpdatesThemeUpdater_2426( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_2426') ) {
    class WPUpdatesThemeUpdater_2426 {
