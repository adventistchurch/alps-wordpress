...
## [3.13.5]
### Fixed
- Updated to fix the defaults based on the NAD needs.

## [3.13.4]
### Fixed
- Update to show the NAD colors.

## [3.13.3]
### Fixed
- Fixed an error with the Kernl update functions.

## [3.13.2]
### Fixed
- Fixed the error that made the custom logo appear on all sites. [#3](https://github.com/NAD-ITS/alps-wordpress/issues/3)
