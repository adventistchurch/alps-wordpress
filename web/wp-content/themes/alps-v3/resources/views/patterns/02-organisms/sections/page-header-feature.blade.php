@php
  ...
  if ($thumb_id) {
    ...
    $block_class = "c-block__inline c-media-block__inine l-grid--7-col l-grid-wrap u-theme--background-color--darker can-be--dark-dark u-padding--top u-padding--bottom";
